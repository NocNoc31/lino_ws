...
Encoder motor2_encoder(MOTOR2_ENCODER_A, MOTOR2_ENCODER_B, COUNTS_PER_REV, true); 
...
void moveBase()
{
    ...
    Kinematics::rpm req_rpm = kinematics.getRPM(g_req_linear_vel_x, g_req_linear_vel_y, 0.5*g_req_angular_vel_z);

//    char log_buffer[100];
//    sprintf(log_buffer, "Required velocities - Linear X: %.2f, Linear Y: %.2f, Angular Z: %.2f", 
